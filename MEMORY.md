...
## 五、Git 提交历史（按时间倒序）
1. 47df4b1 feat: migrate to react-router-dom v7
2. 488acb6 feat: add CozyPaws pet store hero landing page
3. bf0b50b feat: add Marketeam marketing talent platform landing page
4. 63e45ed feat: add Mainframe interactive hero
5. da410dc feat: add RIVR DeFi dashboard hero
6. f7480b4 feat: add Prisma creative studio landing page
7. 8bc977e feat: add SynapseX neural-AI landing page
8. 2fa4931 feat: add Lithos geology hero page
9. 2b88ffd feat: add Viktor Oddy landing page
10. fc9f494 / 35bd2d3 portfolio + prompt
11. 34e06be fix: Jack portfolio mobile layout
12. 922e0ff fix: FoldCraft typography and spacing
13. 3bf8cf7 feat: add Foldcraft hero landing page
14. ee663f5 docs: add AGENTS.md
15. 0e685ca feat: init forest studio project
