# Bloom — AI Plant Design Platform Hero Landing Page
...
`/bloom` → `src/views/Bloom/Bloom.tsx`

## Implementation Notes

- Social brand icons (Twitter/Linkedin/Instagram) replaced with Globe/Users/Camera due to lucide-react v1.x deprecation
- hero-flowers.png replaced with gradient placeholder (no source URL provided)
- Logo implemented as custom SVG (8-petal flower + center circle, all white)
- Background video: downloaded locally to src/assets/images/bloom/bg-video.mp4
