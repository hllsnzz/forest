...
### Fonts (Google Fonts)
- **Inter** (weights: 400, 500, 600) â€?body/UI text
- **DM Serif Display** (weight: 400) â€?hero heading only
...
### Tablet Layout (md to lg) â€?Similar to desktop but smaller
- Heading: text-7xl
...
|-------|----------|----------|--------|
| `.animate-fade-up` | 0â†?0px translateY, 0â†? opacity | 0.8s | cubic-bezier(0.16, 1, 0.3, 1) |
| `.animate-fade-in` | 0â†? opacity | 0.6s | ease-out |
| `.animate-slide-up` | 0â†?0px translateY | 0.9s | cubic-bezier(0.16, 1, 0.3, 1) |
| `.animate-slide-in-left` | -40pxâ†? translateX | 0.8s | cubic-bezier(0.16, 1, 0.3, 1) |
| `.animate-slide-in-right` | 40pxâ†? translateX | 0.8s | cubic-bezier(0.16, 1, 0.3, 1) |
| `.animate-text-reveal` | translateY(40px) skewY(3deg) blur(4px) â†?none | 1s | cubic-bezier(0.16, 1, 0.3, 1) |
| `.animate-word-pop` | translateY(60px) scale(0.7) rotate(-4deg) blur(8px) â†?bounce overshoot â†?settle | 0.9s | cubic-bezier(0.34, 1.56, 0.64, 1) |
| `.animate-scale-in` | scale(0.85)â†? | 0.7s | cubic-bezier(0.16, 1, 0.3, 1) |
| `.animate-photo-reveal` | translateY(80px) scale(1.02) â†?normal | 1.1s | cubic-bezier(0.16, 1, 0.3, 1) |
