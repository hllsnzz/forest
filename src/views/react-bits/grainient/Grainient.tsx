/**
 * Grainient — WebGL 着色器驱动的动态渐变组件
 * 源: React Bits (JavaScript + CSS 变体)
 * 依赖: ogl (WebGL 抽象层)
 */
...
export default function Grainient({
  ...
  /* Effect 2: 同步 props 到 uniforms（零 GPU 重建成本） */
  useEffect(() => {
    const container = containerRef.current;
    if (!container) return;
